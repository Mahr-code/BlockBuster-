      ...
      <div className="footer-container">
        <div className="footer-section">
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              Blockbuster <span className="footer-logo-accent">News</span>
            </Link>
          ...
          <div className="footer-social">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="Visit our GitHub">
              <svg viewBox="0 0 24 24" width="24" height="24" aria-hidden="true">
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {year} Blockbuster News. All rights reserved.
          </p>
          <p className="footer-credits">
            Made with <span aria-hidden="true">❤️</span>
            <span className="sr-only">love</span> by the Blockbuster team
          </p>
        </div>
      </div>
    </footer>
